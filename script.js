...
const articles = {
    'future-pharmacy': {
        ...
        author: 'Dongo Sira',
        date: 'AUG 15, 2025',
        image: 'https://picsum.photos/seed/article1/1200/600',
    ...
    'community-pharmacy': {
        ...
        author: 'John Smith',
        date: 'May 12, 2025',
        image: 'https://picsum.photos/seed/article2/1200/600',
    ...
    'upsa-advocacy': {
        ...
        author: 'UPSA PR Team',
        date: 'May 10, 2025',
        image: 'https://picsum.photos/seed/article3/1200/600',
    ...
    'access-medicines': {
        ...
        date: 'May 8, 2025',
        image: 'https://picsum.photos/seed/article4/1200/600',
    ...
    'new-regulations': {
        ...
        date: 'May 5, 2025',
        image: 'https://picsum.photos/seed/article5/1200/600',
    ...
    'digital-transformation': {
        ...
        author: 'Pharmacy News',
        date: 'April 30, 2025',
        image: 'https://picsum.photos/seed/article6/1200/600',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    const phoneRegex = /^\+256\s?7[0-9]{2}\s?[0-9]{3}\s?[0-9]{3}$/;
    if (!whatsapp.value.trim()) {
      showError('whatsappError', 'WhatsApp number is required.');
      isValid = false;
    } else if (!phoneRegex.test(whatsapp.value.trim())) {
      showError('whatsappError', 'Enter a valid Ugandan number (e.g., +256 7XX XXX XXX).');
      isValid = false;
    }

    // If valid, submit form and show success
    if (isValid) {
      ...
      // form.submit(); // Uncomment if you want to send even with JS validation
    }
  });
